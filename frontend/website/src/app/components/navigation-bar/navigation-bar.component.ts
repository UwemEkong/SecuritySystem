...
export class NavigationBarComponent implements OnInit {
  ...
  constructor(
    private router: Router, private auth: AuthService, private pref: PreferencesService, public locationService: LocationService, private mediaxService: MediaxService, public deviceService: DeviceService) {
  }
